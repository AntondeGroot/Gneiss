...
#
# The three steps have to happen in order and each has a way of going wrong
# quietly, which is what this script is really for:
#
...
# ——— Install ———
#
# -r reinstalls in place and keeps app data, which is where the remembered vault
# folder lives. Without it the folder has to be picked again.

echo "→ installing on $SERIAL"
"$ADB" -s "$SERIAL" install -r "$APK"

printf '\nInstalled. Open Gneiss on the phone.\n'
